  defmodule Aoc2021.Day13.Shelved do
    ...
    * if the offset was incorrect for the merge, but you coincidentally calculate an offset which still gives the right answer becase
    ...
    defp merge_cells(_k, g1_v, g2_v) do
      if g1_v == "#" or g2_v == "#" do
        "#"
      else
        "."
    ...
    def fold_left(grid, fold_line_x) do
      ...
      offset = { g_left.x_max - g_right.x_max , 0}
      # offset = {0, 1}

      flipped_g_right = Grid2D.flip_horiz(g_right)

      Grid2D.merge(g_left, flipped_g_right, offset, &merge_cells/3)
    end
