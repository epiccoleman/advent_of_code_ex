defmodule Aoc2020.Day24Test do
  use ExUnit.Case
  ...
  test "sample 2" do
    input = FileUtils.get_file_as_strings("./test/aoc_2020/day24/small-input.txt")
  ...
  data_test "Part 2 sample" do
    tile_map = FileUtils.get_file_as_strings("./test/aoc_2020/day24/small-input.txt") |> input_to_tile_map()
  ...
  test "Part 1" do
    input = FileUtils.get_file_as_strings("./test/aoc_2020/day24/input.txt")
