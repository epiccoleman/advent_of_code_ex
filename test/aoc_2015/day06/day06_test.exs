defmodule Aoc2015.Day06Test do
  ...
  test "process_input" do
    ...
    assert Day06.process_input(input) == [
      {:on, 489..759, 959..964},
      {:off, 820..871, 516..914},
  ...
  @tag slow: true
  test "Part 1" do
   input = get_file_as_strings("./test/aoc_2015/day06/input.txt")
   assert Day06.part_1(input) == 569999
  end

  @tag slow: true
  test "Part 2" do
   input = get_file_as_strings("./test/aoc_2015/day06/input.txt")
   assert Day06.part_2(input) == 17836115
  end
end
