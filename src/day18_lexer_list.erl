...
-module(day18_lexer_list).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/day18_lexer_list.xrl", 11).
...
-file("src/day18_lexer_list.erl", 307).
yystate() -> 4.
...
-file("src/day18_lexer_list.xrl", 3).
yyaction_0(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/day18_lexer_list.xrl", 4).
yyaction_1(TokenChars, TokenLine) ->
     { token, { operator, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/1}).
-file("src/day18_lexer_list.xrl", 5).
yyaction_2(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/day18_lexer_list.xrl", 6).
yyaction_3(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_4/0}).
-file("src/day18_lexer_list.xrl", 7).
yyaction_4() ->
     skip_token .
