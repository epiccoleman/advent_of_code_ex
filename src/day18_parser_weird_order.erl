...
-file("src/day18_parser_weird_order.erl", 183).
...
-file("src/day18_parser_weird_order.yrl", 2).
...
-file("src/day18_parser_weird_order.yrl", 5).
...
-file("src/day18_parser_weird_order.yrl", 8).
...
-file("src/day18_parser_weird_order.yrl", 7).
...
-file("src/day18_parser_weird_order.yrl", 1).
...
-file("src/day18_parser_weird_order.yrl", 4).
