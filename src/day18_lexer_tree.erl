...
-file("src/day18_lexer_tree.erl", 307).
yystate() -> 7.
...
yystate(8, [10|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line+1, Tlen+1, 7, Tlen);
...
-file("src/day18_lexer_tree.xrl", 2).
yyaction_0(TokenChars) ->
     { token, { number, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/1}).
-file("src/day18_lexer_tree.xrl", 4).
yyaction_1(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/day18_lexer_tree.xrl", 5).
yyaction_2(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/day18_lexer_tree.xrl", 7).
yyaction_3(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/day18_lexer_tree.xrl", 8).
yyaction_4(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/day18_lexer_tree.xrl", 9).
yyaction_5(TokenLine) ->
     { token, { '*', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/day18_lexer_tree.xrl", 10).
yyaction_6(TokenLine) ->
     { token, { '/', TokenLine } } .

-compile({inline,yyaction_7/0}).
-file("src/day18_lexer_tree.xrl", 12).
yyaction_7() ->
     skip_token .
