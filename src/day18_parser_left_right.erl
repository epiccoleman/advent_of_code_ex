-module(day18_parser_left_right).
...
-file("src/day18_parser_left_right.erl", 183).
...
-file("src/day18_parser_left_right.yrl", 3).
...
-file("src/day18_parser_left_right.yrl", 6).
...
-file("src/day18_parser_left_right.yrl", 9).
...
-file("src/day18_parser_left_right.yrl", 8).
...
-file("src/day18_parser_left_right.yrl", 1).
...
-file("src/day18_parser_left_right.yrl", 2).
