...
-file("src/day18_parser_list.erl", 185).
...
-file("src/day18_parser_list.yrl", 9).
...
-file("src/day18_parser_list.yrl", 4).
...
-file("src/day18_parser_list.yrl", 1).
...
-file("src/day18_parser_list.yrl", 7).
...
-file("src/day18_parser_list.yrl", 8).
...
-file("src/day18_parser_list.yrl", 5).
...
-file("src/day18_parser_list.yrl", 2).
...
-file("src/day18_parser_list.yrl", 17).
