...
-file("src/day18_parser.yrl", 15).

extract_token({_Token, _Line, Value}) -> Value.
-file("/Users/eric/.asdf/installs/erlang/23.1.1/lib/parsetools-2.2/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
